...
<div class="container">
    <div class="row mb-2">
        ...
        <div class="col-3">
            <a href="{{ route('place_image.create', $place->id) }}" class="btn btn-outline-primary float-end  px-4 me-3"> + Add</a>
                ...
                <table class="table table-hover align-middle bg-white border text-center">
                    <thead class="small table-success">
                        <tr>
                            ...
                            <th class="col-4">DESCRIPTIOON</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="col-4">{{ $place_image->description }}</td>
                            <td class="col-1">{{ $place_image->created_at }}</td>
                            <td class="col-1">{{ $place_image->updated_at }}</td>
 
                            <td class="col-1">
                                <a href="{{ route('place_image.edit', $place_image) }}" class="border-0 bg-transparent text-warning me-4">
