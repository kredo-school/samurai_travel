<div class="row align-items-center">
    ...
    <div class="gt-circle d-flex m-1 justify-content-center align-items-center">
    ...
    <div class="col shadow rounded mb-4 p-4 howto">
        ...
        <div >&#9313; By registering keywords that match your preferences, plans tailored to your preferences will be displayed.</div>
    </div>
</div>